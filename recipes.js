...
window.initialRecipes = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: { en: "Cooked Ham (Gekookte Hesp / Jambon)", nl: "Gekookte achterham (Gekookte Hesp / Jambon)", fr: "Jambon cuit (Gekookte Hesp / Jambon)" }, amount: 8, unit: "slices", category: "Slagerij & Gevogelte" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: { en: "Minced Meat (Gehakt / Haché)", nl: "Gemengd gehakt (Gehakt / Haché)", fr: "Hachis (Gehakt / Haché)" }, amount: 250, unit: "g", category: "Slagerij & Gevogelte" },
      { name: { en: "Puff Pastry Shells (Videekoppen)", nl: "Videekoppen (Videekoppen)", fr: "Croûtes feuilletées (Videekoppen)" }, amount: 4, unit: "st.", category: "Bakkerij" },
      { name: { en: "Mushrooms (Champignons)", nl: "Witte champignons (Champignons)", fr: "Champignons de Paris (Champignons)" }, amount: 250, unit: "g", category: "Groenten & Fruit" },
      { name: { en: "Heavy Cream (Room / Crème)", nl: "Volle room (Room / Crème)", fr: "Crème liquide (Room / Crème)" }, amount: 150, unit: "ml", category: "Zuivel & Eieren" },
      { name: { en: "Egg yolk (Eidooier / Jaune d'oeuf)", nl: "Eidooier (Eidooier / Jaune d'oeuf)", fr: "Jaune d'œuf (Eidooier / Jaune d'oeuf)" }, amount: 1, unit: "st.", category: "Zuivel & Eieren" }
    ]
  },
  {
    id: "stoemp-worst",
    ...
    ingredients: [
      { name: { en: "Potatoes (Aardappelen / Pommes de terre)", nl: "Bintje aardappelen (Aardappelen / Pommes de terre)", fr: "Pommes de terre Bintje (Aardappelen / Pommes de terre)" }, amount: 1000, unit: "g", category: "Groenten & Fruit" },
      ...
      { name: { en: "Butter (Boter / Beurre)", nl: "Boter (Boter / Beurre)", fr: "Beurre (Boter / Beurre)" }, amount: 30, unit: "g", category: "Zuivel & Eieren" },
      { name: { en: "Milk (Melk / Lait)", nl: "Volle melk (Melk / Lait)", fr: "Lait (Melk / Lait)" }, amount: 100, unit: "ml", category: "Zuivel & Eieren" }
    ]
  },
  {
    id: "moules-frites",
    ...
    ingredients: [
      ...
      { name: { en: "Celery stalks (Bladselder / Céleri)", nl: "Bladselder (Bladselder / Céleri)", fr: "Céleri branche (Bladselder / Céleri)" }, amount: 4, unit: "st.", category: "Groenten & Fruit" },
      { name: { en: "Onions (Uien / Oignons)", nl: "Uien (Uien / Oignons)", fr: "Oignons (Uien / Oignons)" }, amount: 2, unit: "st.", category: "Groenten & Fruit" },
      { name: { en: "Potatoes (Aardappelen / Pommes de terre)", nl: "Bintje aardappelen (voor frieten)", fr: "Pommes de terre (pour frites)" }, amount: 1000, unit: "g", category: "Groenten & Fruit" },
      { name: { en: "Butter (Boter / Beurre)", nl: "Roomboter (Boter / Beurre)", fr: "Beurre (Boter / Beurre)" }, amount: 30, unit: "g", category: "Zuivel & Eieren" }
    ]
  },
  {
    ...
    ingredients: [
      { name: { en: "White Asparagus (Witte Asperges)", nl: "Witte asperges (Witte Asperges)", fr: "Asperges blanches (Witte Asperges)" }, amount: 1000, unit: "g", category: "Groenten & Fruit" },
      { name: { en: "Eggs (Eieren / Oeufs)", nl: "Eieren (Eieren / Oeufs)", fr: "Œufs (Eieren / Oeufs)" }, amount: 4, unit: "st.", category: "Zuivel & Eieren" },
      { name: { en: "Butter (Boter / Beurre)", nl: "Roomboter (Boter / Beurre)", fr: "Beurre de ferme (Boter / Beurre)" }, amount: 150, unit: "g", category: "Zuivel & Eieren" },
      { name: { en: "Fresh Parsley (Peterselie / Persil)", nl: "Verse peterselie (Peterselie / Persil)", fr: "Persil frais (Peterselie / Persil)" }, amount: 1, unit: "bunch", category: "Groenten & Fruit" }
    ]
  },
  {
    id: "tomate-crevettes",
    ...
    isNutFree: true,
    isDairyFree: true,
    isEggFree: false, // contains eggs in mayo
    isVegetarian: false,
    isVegan: false,
    isCandidaFriendly: true,
    isKeto: true,
    ...
    ingredients: [
      { name: { en: "Beefsteak Tomatoes (Vleestomaten)", nl: "Vleestomaten (Vleestomaten)", fr: "Tomates charnues (Vleestomaten)" }, amount: 4, unit: "st.", category: "Groenten & Fruit" },
      { name: { en: "Grey North Sea Shrimps (Grijze Garnalen)", nl: "Grijze Noordzeegarnalen (Grijze Garnalen)", fr: "Crevettes grises (Grijze Garnalen)" }, amount: 300, unit: "g", category: "Visafdeling" },
      { name: { en: "Mayonnaise (Belgian style)", nl: "Belgische mayonaise (Mayonaise)", fr: "Mayonnaise belge (Mayonaise)" }, amount: 3, unit: "el", category: "Kruidenier" },
      { name: { en: "Lemon juice & Parsley", nl: "Citroensap en peterselie", fr: "Jus de citron et persil" }, amount: 1, unit: "to taste", category: "Groenten & Fruit" }
    ]
  },
  {
    id: "vegan-waterzooi",
    ...
    ingredients: [
      { name: { en: "Firm Tofu (Natuurtofu)", nl: "Stevige natuurtofu (Tofu)", fr: "Tofu ferme (Tofu)" }, amount: 400, unit: "g", category: "Kruidenier" },
      { name: { en: "Carrots & Leeks & Celery", nl: "Wortelen, prei en bladselder", fr: "Carottes, poireaux et céleri" }, amount: 1, unit: "bundle", category: "Groenten & Fruit" },
      { name: { en: "Potatoes (Aardappelen / Pommes de terre)", nl: "Vastkokende aardappelen", fr: "Pommes de terre" }, amount: 400, unit: "g", category: "Groenten & Fruit" },
      { name: { en: "Vegetable Broth (Groentenbouillon)", nl: "Groentenbouillon", fr: "Bouillon de légumes" }, amount: 750, unit: "ml", category: "Kruidenier" },
      { name: { en: "Oat Cream (Haverroom / Crème d'avoine)", nl: "Haverroom (Haverroom / Crème d'avoine)", fr: "Crème d'avoine (Haverroom / Crème d'avoine)" }, amount: 200, unit: "ml", category: "Zuivel & Eieren" }
    ]
  },
  {
    id: "chicoree-salade",
    ...
    difficulty: { en: "Easy", nl: "Gemakkelijk", fr: "Facile" },
    servings: 2,
    category: { en: "Comfort Food", nl: "Ontdek", fr: "Plats Réconfortants" },
    image: "images/witloof_gratin.jpg", // reuse endives card image
    isGlutenFree: true,
    isNutFree: false, // contains walnuts
    isDairyFree: true,
    isEggFree: true,
    isVegetarian: true,
    isVegan: true,
    ...
    ingredients: [
      { name: { en: "Belgian Endives (Witloof / Chicons)", nl: "Witloof (Witloof / Chicons)", fr: "Chicons (Witloof / Chicons)" }, amount: 4, unit: "st.", category: "Groenten & Fruit" },
      { name: { en: "Walnuts (Walnoten / Noix)", nl: "Walnoten (Walnoten / Noix)", fr: "Noix (Walnoten / Noix)" }, amount: 75, unit: "g", category: "Bakkerij" },
      { name: { en: "Extra Virgin Olive Oil (Olijfolie)", nl: "Extra vierge olijfolie (Olijfolie)", fr: "Huile d'olive extra vierge (Olijfolie)" }, amount: 3, unit: "el", category: "Kruidenier" },
      { name: { en: "Lemon juice (Citroensap / Jus de citron)", nl: "Citroensap (Citroensap / Jus de citron)", fr: "Jus de citron frais (Citroensap / Jus de citron)" }, amount: 1, unit: "el", category: "Groenten & Fruit" }
    ]
  },
  {
    id: "keto-stoofvlees",
    ...
    servings: 4,
    category: { en: "Belgian Classics", nl: "Belgische Klassiekers", fr: "Classiques Belges" },
    image: "images/carbonnade_flamande.jpg", // reuse stew cover
    isGlutenFree: true,
    isNutFree: true,
    isDairyFree: true,
    isEggFree: true,
    ...
    ingredients: [
      { name: { en: "Beef chuck (Stoofvlees / Carbonnades)", nl: "Rundstoofvlees (Stoofvlees / Carbonnades)", fr: "Carbonnades de boeuf (Stoofvlees / Carbonnades)" }, amount: 1000, unit: "g", category: "Slagerij & Gevogelte" },
      { name: { en: "Beef Bone Broth (Bottenbouillon)", nl: "Runderbottenbouillon (Bouillon)", fr: "Bouillon d'os de boeuf (Bouillon)" }, amount: 500, unit: "ml", category: "Kruidenier" },
      { name: { en: "Onions & Garlic (Uien / Oignons)", nl: "Uien en knoflook", fr: "Oignons et ail" }, amount: 2, unit: "st.", category: "Groenten & Fruit" },
      { name: { en: "Apple Cider Vinegar (Appelazijn)", nl: "Appelciderazijn (Azijn)", fr: "Vinaigre de cidre (Vinaigre)" }, amount: 3, unit: "el", category: "Kruidenier" },
      { name: { en: "Extra Virgin Olive Oil (Olijfolie)", nl: "Olijfolie (Olijfolie)", fr: "Huile d'olive (Olijfolie)" }, amount: 3, unit: "el", category: "Kruidenier" }
    ]
  },
  {
    id: "gaufre-liege",
    ...
    ingredients: [
      { name: { en: "Flour (Bloem / Farine)", nl: "Tarwebloem (Bloem / Farine)", fr: "Farine de blé (Bloem / Farine)" }, amount: 375, unit: "g", category: "Kruidenier" },
      { name: { en: "Belgian Pearl Sugar (Parelsuiker / Sucre perlé)", nl: "Parelsuiker (Parelsuiker / Sucre perlé)", fr: "Sucre perlé belge (Parelsuiker / Sucre perlé)" }, amount: 150, unit: "g", category: "Kruidenier" },
      { name: { en: "Butter (Boter / Beurre)", nl: "Boter (Boter / Beurre)", fr: "Beurre (Boter / Beurre)" }, amount: 140, unit: "g", category: "Zuivel & Eieren" },
      { name: { en: "Whole Milk (Melk / Lait)", nl: "Lauwe melk (Melk / Lait)", fr: "Lait tiède (Melk / Lait)" }, amount: 100, unit: "ml", category: "Zuivel & Eieren" },
      { name: { en: "Dry Yeast (Gist / Levure)", nl: "Droge gist (Gist / Levure)", fr: "Levure de boulanger (Gist / Levure)" }, amount: 7, unit: "g", category: "Kruidenier" },
      { name: { en: "Eggs (Eieren / Oeufs)", nl: "Eieren (Eieren / Oeufs)", fr: "Œufs (Eieren / Oeufs)" }, amount: 2, unit: "st.", category: "Zuivel & Eieren" }
    ]
  },
  {
    id: "vegan-stoemp",
    ...
    servings: 4,
    category: { en: "Comfort Food", nl: "Dagelijkse Kost", fr: "Plats Réconfortants" },
    image: "images/stoemp_worst.jpg", // reuse stoemp cover
    isGlutenFree: true,
    isNutFree: true,
    isDairyFree: true,
    isEggFree: true,
    ...
    ingredients: [
      { name: { en: "Potatoes (Bintje / Aardappelen)", nl: "Aardappelen (Bintje / Aardappelen)", fr: "Pommes de terre Bintje" }, amount: 1000, unit: "g", category: "Groenten & Fruit" },
      { name: { en: "Leeks (Prei / Poireaux)", nl: "Prei (Prei / Poireaux)", fr: "Poireaux (Prei / Poireaux)" }, amount: 3, unit: "st.", category: "Groenten & Fruit" },
      { name: { en: "Extra Virgin Olive Oil (Olijfolie)", nl: "Extra vierge olijfolie (Olijfolie)", fr: "Huile d'olive extra vierge" }, amount: 4, unit: "el", category: "Kruidenier" },
      { name: { en: "Nutmeg & Sea Salt", nl: "Nootmuskaat en zeezout", fr: "Noix de muscade et sel marin" }, amount: 1, unit: "to taste", category: "Kruidenier" }
    ]
  }
];
